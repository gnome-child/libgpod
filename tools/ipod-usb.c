...
static int send_command(
    libusb_device_handle *handle, const guint value, const guint index, guchar *data, gsize len) {
...
open_handle(libusb_context *ctx, const guint bus_number, const guint device_address) {
    libusb_device **list;
    libusb_device *dev;
